...
export const ShoppingProvider = ({ children }) => {
  ...
  const agregarMenu = (menuItem) => {
    // Crear una copia del carrito actual y agregar el nuevo menuItem con una cantidad inicial de 1
    const nuevoCarrito = [...carrito, { ...menuItem, cantidad: 1 }];

    // Actualizar el carrito con el nuevo arreglo que contiene el menuItem agregado
    setCarrito(nuevoCarrito);
  };
